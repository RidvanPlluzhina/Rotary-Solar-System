...
bool buttonDState = false;       // Tracks the current state of the button
...
void loop() {
  ...
  buttonDState = digitalRead(buttonD) == LOW;  

  if (buttonDState && !lastButtonDState) { // Trigger only when button is pressed
